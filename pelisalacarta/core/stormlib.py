...
def getpreferences():
    logger.info("[stormlib.py] getpreferences ")                  
    ...
    if not os.path.exists(PATH):                                                
       logger.info("Creating data_path "+PATH)                                         
       try:                                                                     
         mkdir_p(PATH)                                                       
       except:                                                                  
         pass
    ...
    if not os.path.exists(xml):                                                                                         
       status="1"                                                                                                     
       logger.info( "[stormlib.py] getpreferences "+status  )
    else: 
...
def removefollow(tvs_id):
    ...
    logger.info( "[stormlib.py] Remove follow")
...
def getwatched(tvs_id):
    logger.info( "[stormlib.py] getwatched"+tvs_id)
    user_id=config.get_setting("stormtvuser")
    user_pass=config.get_setting("stormtvpassword")
    chap_dictionary = {}                                                                                                                                                          
    #server= "https://"+__server__+"/stormtv/public/"                                                                                                                               
    ...
    for chapter in chapters:                                                                                                                                                      
        ...
        logger.info( number+chap_dictionary[number]+"#")
    return chap_dictionary

def getlang():
    logger.info( "[stormlib.py] getlang")
    #path=config.get_data_path()+"stormtv/temp/"
    xml=PATH+"/"+"preferences.xml"
    if not os.path.exists(xml):                                                                                         
        status="0"                                                                                                      
    ...
    logger.info( "[stormlib.py] getlang"+status)
    return status  
...
def getservers():
    ...
    logger.info( "[stormlib.py] getservers"+status)
    return status

def setwatched (tvs_id,chap_number):
    logger.info("[stormlib.py] setwatched"+tvs_id+" "+chap_number)
    user_id=config.get_setting("stormtvuser")
    user_pass=config.get_setting("stormtvpassword")
    #server= "https://"+__server__+"/stormtv/public/"                                                                                                                               
    #path=config.get_data_path()+"stormtv/temp/"
    logger.info("[stormlib.py] setwatched "+SERVER+"chapters/add/tvs/"+tvs_id+"/user/"+user_id+"/pass/"+user_pass+"/chap/"+chap_number)
...
def gettvslist (tvsl_id):
    logger.info("[stormlib.py] gettvslist"+tvsl_id)
    user_id=config.get_setting("stormtvuser")                                                                                                                                     
    user_pass=config.get_setting("stormtvpassword")                                                                                                                               
    #server= "https://"+__server__+"/stormtv/public/"                                                                                                                             
    #path=config.get_data_path()+"stormtv/temp/"                                                                                                                                  
...
def getalltvslist():
    logger.info("[stormlib.py] getalltvslist")                                                                                       
    user_id=config.get_setting("stormtvuser")                                                                                       
    user_pass=config.get_setting("stormtvpassword")                                                                                 
    #server= "https://"+__server__+"/stormtv/public/"                                                                               
    #path=config.get_data_path()+"stormtv/temp/"                                                                                    
...
def getpopular():
    logger.info("[stormlib.py] getpopular")                                                                                            
    user_id=config.get_setting("stormtvuser")                                                                                       
    user_pass=config.get_setting("stormtvpassword")                                                                                 
    #server= "https://"+__server__+"/stormtv/public/"                                                                               
    #path=config.get_data_path()+"stormtv/temp/"                                                                                    
...
def isfollow (tvs_id):
    logger.info("[stormlib.py] isfollow"+ tvs_id)
    user_id=config.get_setting("stormtvuser")                                                                                                   
    user_pass=config.get_setting("stormtvpassword")
    #server= "https://"+__server__+"/stormtv/public/"
...
def audio_serieonline(title):
    logger.info("[stormlib.py]audio_serionline "+title)
...
def combined(seasonepisode):
	logger.info("[stormlib.py]combined "+seasonepisode)
	patron = "(.*)x(.*)"
	matches = re.compile(patron,re.DOTALL).findall(seasonepisode)
	for season,episode in matches:
		sea=season
		epi=episode
	logger.info("Season "+sea+" Episode "+epi)
	return season,episode

def audio_seriesyonkis(title):
	logger.info("[stormlib.py]audio_seriesyonkis "+title)
...
def servers_divxonline(title):
	logger.info("[stormlib.py]servers_divxonline"+title)
	patron_moe="moevideo"
	...
	return n_title
def verify(itemlist):
	logger.info("[stormlib.py] verify")	
	strue=1                                                                                                                                                           
	ltrue=1                                                                                                                                                           
        excluded=[]                                                                                                                                                       
	...
	for item in itemlist:
		channel=item.fulltitle                                                                                                                                          
                logger.info("[verify]channel:"+channel)
		vserver=item.server                                                                                                                                       
                logger.info("Server="+vserver+" URL="+item.url)
		if (channel<>"seriesyonkis"):                                                                                                                  
                   if ((vserver not in verified)&(vserver not in excluded)):                                                                                                 
                	   try:                                                                                                                                                   
                              exec "import servers."+vserver+" as tserver"                                                                                                        
                           except:                                                                                                                                                
                                logger.info("[stormtv.py] Verified no existe el servidor")                                                                                             
                           try:                                                                                                                                                   
                              data =scrapertools.cache_page(item.url)                                                                                                             
                           except:                                                                                                                                                
                                logger.info("[stormtv.py] Verified no se puede descargar la pagina")
			   if (channel<>"shurweb"):                                                                                     
                           	logger.info("dentro del if<>shurweb")
				try:                                                                                                                                                   
                              		resultado = tserver.find_videos(data)                                                                                                               
                           	except:                                                                                                                                                
                                	logger.info("[stormtv.py] Verified no find_videos")                                                                                                       
                           	try:                                                                                                                                                   
                              		res,test= tserver.test_video_exists(resultado[0][1])                                                                                                
                           	except:                                                                                                                                                
                              		logger.info("[stormtv.py] Verified fallo test_video_exist "+vserver)                                                                                     
                              		res=False
			   else:
				logger.info("dentro del else<>shurweb")
				try:
...
def find_video_storm(item=None, data=None, channel=""):                                                                                                                           
    ...
    logger.info("[find_video_storm] Server"+item.server)                                                                                                                                                                           
    if item is None:                                                                                                                                                              
        item = Item()                                                                                                                                                             
...
def get_filenium_status():                                                                                                                                                                 
    ...
    logger.info("[Filenium.py] get_status")                                                                                                                                     
...
#    doc.writexml(out)
def filenium():
    logger.info("[stormlib.py] filenium dictionary")                                                                                                                                    
    filenium_dictionary = {}                                                                                                                                                          
    #server= "https://"+__server__+"/stormtv/public/"                                                                                                                             
    #path=config.get_data_path()+"stormtv/temp/"                                                                                                                                  
	...
	if (status=="activehost"):
        ...
        logger.info(name+filenium_dictionary[name.upper()]+"#")                                                                                                                               
