...
def mainlist(item):
    ...
    itemlist.append( Item(channel=__channel__ , action="subforos"   , title="Peliculas Online"      , url="http://pordescargadirecta.com/peliculas-online-f270/"))
    itemlist.append( Item(channel=__channel__ , action="subforos"   , title="Series Online"         , url="http://pordescargadirecta.com/series-online-f227/"))
    itemlist.append( Item(channel=__channel__ , action="posts"   , title="Documentales y Televisión Online"         , url="http://pordescargadirecta.com/documentales-y-television-online-f399/"))
    itemlist.append( Item(channel=__channel__ , action="posts"   , title="Anime"         , url="http://pordescargadirecta.com/anime-online-f400/"))
