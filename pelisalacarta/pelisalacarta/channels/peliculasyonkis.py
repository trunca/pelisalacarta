...
__date__ = "02/05/2011"
__creationdate__ = ""
__changes__ = "Arreglado un problema con la expresión regular de los listados de pelis. Ahora salen muchas más :)"
__thumbnail__ = ""
...
def mainlist(params,url,category):
    ...
    xbmctools.addnewfolder( __channel__ , "listnovedades"  , category , "Estrenos de cartelera" ,"http://www.peliculasyonkis.sx/ultimas-peliculas/cartelera/","","")
    xbmctools.addnewfolder( __channel__ , "listnovedades"  , category , "Estrenos de DVD" ,"http://www.peliculasyonkis.sx/ultimas-peliculas/estrenos-dvd/","","")
    xbmctools.addnewfolder( __channel__ , "listnovedades"  , category , "Ultimas Peliculas Actualizadas","http://www.peliculasyonkis.sx/ultimas-peliculas/actualizadas/","","")
    xbmctools.addnewfolder( __channel__ , "listnovedades"  , category , "Ultimas peliculas añadidas a la web","http://www.peliculasyonkis.sx/ultimas-peliculas/estrenos-web/","","")
    xbmctools.addnewfolder( __channel__ , "listcategorias" , category , "Listado por categorias","http://www.peliculasyonkis.sx/","","")
    xbmctools.addnewfolder( __channel__ , "listalfabetico" , category , "Listado alfabético","http://www.peliculasyonkis.sx/","","")
    xbmctools.addnewfolder( __channel__ , "buscaporanyo"   , category , "Busqueda por Año","http://www.peliculasyonkis.sx/","","")
...
def performsearch(texto):
    ...
    for match in matches:
        ...
        # Av±ade al listado de XBMC
        resultados.append( [__channel__ , "detailfolder" , "buscador" , scrapedtitle , scrapedurl , scrapedthumbnail, scrapedplot ] )
...
def searchresults(params,Url,category):
    ...
    for match in matches:
        ...
        scrapedplot = ""
        if (DEBUG): logger.info("title=["+scrapedtitle+"], url=["+scrapedurl+"], thumbnail=["+scrapedthumbnail+"]")
        xbmctools.addnewvideo( __channel__ , "detail" , category , "Megavideo" , scrapedtitle , scrapedurl , scrapedthumbnail , scrapedplot )
...
def listalfabetico(params, url, category):
    ...
    xbmctools.addnewfolder( __channel__ ,"listvideos", category , "0-9","http://www.peliculasyonkis.sx/lista-peliculas/listaPeliculasNumeric.php","","")
    xbmctools.addnewfolder( __channel__ ,"listvideos", category , "A","http://www.peliculasyonkis.sx/lista-peliculas/listaPeliculasA.php","","")
    xbmctools.addnewfolder( __channel__ ,"listvideos", category , "B","http://www.peliculasyonkis.sx/lista-peliculas/listaPeliculasB.php","","")
    xbmctools.addnewfolder( __channel__ ,"listvideos", category , "C","http://www.peliculasyonkis.sx/lista-peliculas/listaPeliculasC.php","","")
    xbmctools.addnewfolder( __channel__ ,"listvideos", category , "D","http://www.peliculasyonkis.sx/lista-peliculas/listaPeliculasD.php","","")
    xbmctools.addnewfolder( __channel__ ,"listvideos", category , "E","http://www.peliculasyonkis.sx/lista-peliculas/listaPeliculasE.php","","")
    xbmctools.addnewfolder( __channel__ ,"listvideos", category , "F","http://www.peliculasyonkis.sx/lista-peliculas/listaPeliculasF.php","","")
    xbmctools.addnewfolder( __channel__ ,"listvideos", category , "G","http://www.peliculasyonkis.sx/lista-peliculas/listaPeliculasG.php","","")
    xbmctools.addnewfolder( __channel__ ,"listvideos", category , "H","http://www.peliculasyonkis.sx/lista-peliculas/listaPeliculasH.php","","")
    xbmctools.addnewfolder( __channel__ ,"listvideos", category , "I","http://www.peliculasyonkis.sx/lista-peliculas/listaPeliculasI.php","","")
    xbmctools.addnewfolder( __channel__ ,"listvideos", category , "J","http://www.peliculasyonkis.sx/lista-peliculas/listaPeliculasJ.php","","")
    xbmctools.addnewfolder( __channel__ ,"listvideos", category , "K","http://www.peliculasyonkis.sx/lista-peliculas/listaPeliculasK.php","","")
    xbmctools.addnewfolder( __channel__ ,"listvideos", category , "L","http://www.peliculasyonkis.sx/lista-peliculas/listaPeliculasL.php","","")
    xbmctools.addnewfolder( __channel__ ,"listvideos", category , "M","http://www.peliculasyonkis.sx/lista-peliculas/listaPeliculasM.php","","")
    xbmctools.addnewfolder( __channel__ ,"listvideos", category , "N","http://www.peliculasyonkis.sx/lista-peliculas/listaPeliculasN.php","","")
    xbmctools.addnewfolder( __channel__ ,"listvideos", category , "O","http://www.peliculasyonkis.sx/lista-peliculas/listaPeliculasO.php","","")
    xbmctools.addnewfolder( __channel__ ,"listvideos", category , "P","http://www.peliculasyonkis.sx/lista-peliculas/listaPeliculasP.php","","")
    xbmctools.addnewfolder( __channel__ ,"listvideos", category , "Q","http://www.peliculasyonkis.sx/lista-peliculas/listaPeliculasQ.php","","")
    xbmctools.addnewfolder( __channel__ ,"listvideos", category , "R","http://www.peliculasyonkis.sx/lista-peliculas/listaPeliculasR.php","","")
    xbmctools.addnewfolder( __channel__ ,"listvideos", category , "S","http://www.peliculasyonkis.sx/lista-peliculas/listaPeliculasS.php","","")
    xbmctools.addnewfolder( __channel__ ,"listvideos", category , "T","http://www.peliculasyonkis.sx/lista-peliculas/listaPeliculasT.php","","")
    xbmctools.addnewfolder( __channel__ ,"listvideos", category , "U","http://www.peliculasyonkis.sx/lista-peliculas/listaPeliculasU.php","","")
    xbmctools.addnewfolder( __channel__ ,"listvideos", category , "V","http://www.peliculasyonkis.sx/lista-peliculas/listaPeliculasV.php","","")
    xbmctools.addnewfolder( __channel__ ,"listvideos", category , "W","http://www.peliculasyonkis.sx/lista-peliculas/listaPeliculasW.php","","")
    xbmctools.addnewfolder( __channel__ ,"listvideos", category , "X","http://www.peliculasyonkis.sx/lista-peliculas/listaPeliculasX.php","","")
    xbmctools.addnewfolder( __channel__ ,"listvideos", category , "Y","http://www.peliculasyonkis.sx/lista-peliculas/listaPeliculasY.php","","")
    xbmctools.addnewfolder( __channel__ ,"listvideos", category , "Z","http://www.peliculasyonkis.sx/lista-peliculas/listaPeliculasZ.php","","")
...
def listvideos(params,url,category):
    ...
    for match in matches:
        ...
        # Av±ade al listado de XBMC
        xbmctools.addnewvideo( __channel__ , "detail" , category , "Megavideo" , scrapedtitle , scrapedurl , scrapedthumbnail , scrapedplot , fanart=scrapedthumbnail)
...
def detailfolder(params,url,category):
    ...
    xbmctools.addnewvideo( __channel__ , "detail" , category , "Megavideo" , title , url , thumbnail , plot )
...
def detail(params,url,category):
    ...
    if url == "":return
    xbmctools.play_video(__channel__,SERVER[serv],url,category,title,thumbnail,plot)
