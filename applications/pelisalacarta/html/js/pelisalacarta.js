...
function DescargarContenido(url) {
    AbrirLoading()
    if (url !== "") {
                ItemList ='<li class="ListItem"><a onfocus="DesCargarInfo(this)" class="ListItem" href="javascript:void(0)" onclick="Back()"><div class="ListItem"><span class="ListItem"></span><img class="ListItem" src="css/images/back.png"></div><h3 class="ListItem">Atrás...</h3><p class="ListItem"></p></a></li>'
    } else {
        ItemList = "";
    }
    UltimoRequest = url;
